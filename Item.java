/* Item Class - Handles the creation and random drops of Items in the dungeon. For our implementation we made it so it was only heal potions*/
...
public class Item {
    ...
    public static Item newRandomItem() {
        ...
        int random = ProjectMoria.RAND.nextInt(3) + 1; //returns random item
        switch (random) {
            case 1:
                randomItem = (potion());
            case 2:
